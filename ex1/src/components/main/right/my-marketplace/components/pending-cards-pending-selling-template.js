...
import "./pending-cards-pending-selling-template.css";

import StorefrontButton13 from "../../../../cards-comp/1-over-3-storefront-button";
import CancelPendingButton13 from "../../../../cards-comp/1-over-3-cancel-pending-button";

export default function MarkPendCardSellTemp() {
  return (
